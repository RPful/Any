...
echo ""
echo -e "                 \033[1;31mBy @RP4321\033[1;36m"
echo ""
...
sleep 5
cd /bin || exit
wget https://raw.githubusercontent.com/RPful/Any/main/chany > /dev/null 2>&1
wget https://raw.githubusercontent.com/RPful/Any/main/userscheck > /dev/null 2>&1
...
wget https://raw.githubusercontent.com/RPful/Any/main/checkany.py > /dev/null 2>&1
...
echo ""
echo -e "\033[1;33m MAIS INFORMAÇÕES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@RP4321\033[0m"
